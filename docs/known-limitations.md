...
- Connected Inventory setup lets MFA-verified Owners and Admins define units, conversions, categories, vendors, items, prices, pars, and versioned recipes. No catalog, par, price, or recipe value is inferred from demo data.
