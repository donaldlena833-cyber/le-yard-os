...
export const demoWorkspace: DemoWorkspace = {
  ...
  tipPoolRules: [
    { id: "tip-rule-demo-v1", organizationId: orgId, name: "Le Yard weighted tip pool", version: 1, effectiveFrom: "2026-07-01", effectiveTo: null, method: "weighted_points", eligibleJobRoleIds: [server, bartender, lineCook, prepCook], roleWeights: { [server]: 10, [bartender]: 10, [lineCook]: 6, [prepCook]: 6 }, serviceChargeIncluded: false, status: "active", createdAt: "2026-06-20T10:00:00-04:00", updatedAt: "2026-06-28T10:00:00-04:00" },
  ],
  tipPoolRuns: [
    { id: "tip-run-garden-jul31", organizationId: orgId, locationId: gardenId, ruleId: "tip-rule-demo-v1", businessDate: "2026-07-31", cashTipsCents: 18_600, cardTipsCents: 182_400, serviceChargesCents: 30_000, adjustmentsCents: 0, distributableCents: 201_000, status: "locked", approvedBy: donald, approvedAt: "2026-08-01T10:30:00-04:00", explanation: "Cash and card tips only; service charges remain separate. Shares use worked hours × role points: servers and bartenders 10, support staff 6, with deterministic cent rounding.", allocations: [{ personId: imani, eligibleMinutes: 390, weight: 10, adjustmentCents: 0, allocatedCents: 74_957, excludedReason: null }, { personId: leo, eligibleMinutes: 493, weight: 6, adjustmentCents: 0, allocatedCents: 56_852, excludedReason: null }, { personId: aisha, eligibleMinutes: 480, weight: 0, adjustmentCents: 0, allocatedCents: 0, excludedReason: "Manager role is not eligible in this pool." }, { personId: priya, eligibleMinutes: 360, weight: 10, adjustmentCents: 0, allocatedCents: 69_191, excludedReason: null }], createdAt: "2026-08-01T09:30:00-04:00", updatedAt: "2026-08-01T10:30:00-04:00" },
  ],
  receipts: [
